        ...
        <div className={styles.achievement}>
            <Grid className="lg:grid-cols-12 grid-cols-3">
                ...
                <div className="lg:col-span-7 col-span-2 font-bold [-webkit-box-flex:_1;] shrink grow basis-[0%] w-full">
                    ...
                    <div className="coc-description text-black font-normal">{Util.numberWithSpaces(achievement.info)}</div>
                </div>
                <Center className="lg:col-span-4 col-span-3 w-auto [line-height:_40px;] lg:justify-end">
                    <Center>
                        {achievement.stars == 3 ? 
                        <Center className="coc-description text-[#5E6671] lg:justify-end">{Util.numberWithSpaces(achievement.completionInfo || "")}<img className="w-7" src="/Images/Clash of Clans/check.png"/></Center> : 
