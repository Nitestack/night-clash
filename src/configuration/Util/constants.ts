...
export default class Constants {
    public static websiteApplicationName = "NightClash";
    public static websiteApplicationDescription = " is a community upgrade and stats tracker for a variety of Supercell Games!";
