                ...
                <div className="w-80 sm:w-auto flex flex-col justify-start items-start">
                    ...
                    <div className="mt-4 lg:w-4/5 xl:w-3/5">
                        <p className="text-xl font-coc-description leading-6 text-lightmodetext dark:text-darkmodetext">
                            ...
                            island. You&apos;ll see, when your builder(s) or the
                            armory is available and what is left to upgrade for
                            your Headquarters level. Schedule your builder(s)
                            and your armory and get notified whether an upgrade
                            has finished!
                        </p>
