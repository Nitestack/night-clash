...
const {
    ...
    homeSpellsArray,
    homeDarkSpellsArray,
    homeSuperTroopsArray,
    homeDarkSuperTroopsArray,
    homeSiegeMachinesArray,
} = Util.Constants.CoC;
    ...
    return (
        <Grid
            className={Util.classNames(
                "bg-[linear-gradient(#8A94AD,_#6A7798)] p-3 rounded-lg border border-solid border-lightmodetext dark:border-darkmodetext"
            )}>
            <div className="pb-4">
                <h5>Troops</h5>
                    ...
                    {homeTroopsArray.map((troop, i) => (
                        <div key={i}>
                            ...
                            <Input
                                ...
                                maxLength={3}
                                min={0}
                                max={Math.floor(300 / troopSpace[i])}
                            />
                        </div>
                    ))}
                </Grid>
                    ...
                    {homeSuperTroopsArray.map((superTroop, i) => (
                        <div key={i}>
                            ...
                            <Input
                                ...
                                maxLength={3}
                                min={0}
                                max={Math.floor(300 / superTroopSpace[i])}
                            />
                        </div>
                    ))}
                </Grid>
                    ...
                    {homeDarkTroopsArray.map((darkTroop, i) => (
                        <div key={i}>
                            ...
                            <Input
                                ...
                                maxLength={3}
                                min={0}
                                max={Math.floor(300 / darkTroopSpace[i])}
                            />
                        </div>
                    ))}
                </Grid>
                    ...
                    {homeDarkSuperTroopsArray.map((superDarkTroop, i) => (
                        <div key={i}>
                            ...
                            <Input
                                ...
                                maxLength={3}
                                min={0}
                                max={Math.floor(300 / darkSuperTroopSpace[i])}
                            />
                        </div>
                    ))}
                </Grid>
                    ...
                    {homeSpellsArray.map((spell, i) => (
                        <div key={i}>
                            ...
                            <Input
                                ...
                                min={0}
                                maxLength={2}
                                max={Math.floor(11 / spellSpace[i])}
                            />
                        </div>
                    ))}
                </Grid>
            ...
            <div>
                <Center>
                    <p className="font-coc-description">
                        Troop Housing Space: {troopHousingSpace}
                    </p>
                </Center>
                <Center>
                    <p className="font-coc-description">
                        Spell Housing Space: {spellHousingSpace}
                    </p>
                </Center>
            </div>
        </Grid>
