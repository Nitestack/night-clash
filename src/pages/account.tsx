        ...
        <>
            <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                <div className="px-4 py-5 sm:px-6">
                    ...
                    <p className="mt-1 max-w-2xl text-lg text-gray-500 coc-description"> Personal details and data. </p>
                </div>
                <div className="border-t border-gray-200">
                    <dl>
                        <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt className="text-sm font-medium text-gray-500"> Username </dt>
                            <dd className="mt-1 text-lg coc-description text-gray-900 sm:mt-0 sm:col-span-2"> {session.user?.username} </dd>
                        </div>
                        {session.user?.role == Util.Constants.ADMIN_ROLE_ID ? <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd className="mt-1 text-lg coc-description text-gray-900 sm:mt-0 sm:col-span-2"> Admin </dd>
                        </div> : undefined}
                        <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt className="text-sm font-medium text-gray-500"> E-Mail Address </dt>
                            <dd className="mt-1 text-lg coc-description text-gray-900 sm:mt-0 sm:col-span-2"> {session.user?.email} </dd>
                        </div>
                    </dl>
                </div>
            </div>
