...
const Select = forwardRef<HTMLSelectElement, DetailedHTMLProps<SelectHTMLAttributes<HTMLSelectElement>, HTMLSelectElement> & { options: Array<OptionHTMLAttributes<HTMLOptionElement>>; }>(function(props, ref) {
    return (
        <div className="flex justify-center">
            <div className="mb-3 xl:w-96">
                <select {...omit(["options", "className"], props)} ref={ref}
